...
pairsLo/conf.yaml: pairsAll/confusable_pairs.tsv
	...
	bash scripts/make_pairs.sh refdb pairsAll/confusable_pairs.tsv pairsLo/tmpsim pairsLo/input pairsLo/conf.yaml pairsLo/results `pwd`/EukDetect-ad9edf11f5b458f11386b8a4b7f0e70f7bd69c30 ncbi_eukprot_met_arch_markers.fna 0.01
...
pairsLoBowtie2/results/our-method.results-summary.tsv: pairsLo/conf.yaml
	...
	perl -i -ne 'print unless /taxonA2546455taxonB744408/ or  /taxonA597209taxonB270528/ or  /taxonA1931375taxonB1439350/ or  /taxonA249251taxonB1756245/ or  /taxonA1257118taxonB196912/ or  /taxonA120023taxonB299392/' pairsLoBowtie2/in.tsv
...
pairsMid/conf.yaml: pairsAll/confusable_pairs.tsv
	mkdir -pv pairsMid/tmpsim
	mkdir -pv pairsMid/input
	bash scripts/make_pairs.sh refdb pairsAll/confusable_pairs.tsv pairsMid/tmpsim pairsMid/input pairsMid/conf.yaml pairsMid/results `pwd`/EukDetect-ad9edf11f5b458f11386b8a4b7f0e70f7bd69c30 ncbi_eukprot_met_arch_markers.fna 0.05
