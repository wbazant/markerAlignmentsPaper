...
CORRAL is a freely available tool for detecting eukaryotes in metagenomic samples based on marker genes and clustering of related read alignments. This approach achieves better sensitivity, similar specificity, and additional capabilities compared to existing methods. It is suitable for processing public shotgun metagenomic (WGS) data at scale - deploying CORRAL on our open-science platform, MicrobiomeDB.org, allows automated processing of thousands of samples currently on the site, as well as any metagenomic study loaded in the future. 
...
Our formulas to calculate precision and recall are as used in the OPAL method of assessing taxonomic metagenome profilers [@meyer2019assessing]: precision is a fraction of correctly mapped reads among all reads that mapped, and recall is a fraction of correctly mapped reads among all reads.
